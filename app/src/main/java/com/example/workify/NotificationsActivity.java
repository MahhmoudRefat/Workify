            ...
            public boolean onNavigationItemSelected(@NonNull MenuItem menuItem) {
                ...
                switch (itemid) {
                    ...
                    case R.id.nav_item_favorite:
                        startActivity(new Intent(NotificationsActivity.this,FavoriteAvtivity.class));
                        break;
                    case R.id.nav_item_booking_list:
                        startActivity(new Intent(NotificationsActivity.this,BookingListActivity.class));
                        break;
